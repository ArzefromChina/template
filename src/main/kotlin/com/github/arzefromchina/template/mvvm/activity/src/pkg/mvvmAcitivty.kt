...
import com.github.arzefromchina.template.mvvm.replaceComponent
...
class ${activityClass}Activity : BaseMvvmActivity<${componentName.replaceComponent()}Activity${activityClass}Binding, ${activityClass}ViewModel>() {
    ...
    override fun initContentView(savedInstanceState: Bundle?) = 
        R.layout.${componentName}${layoutName}
 
 
    override fun createViewModel(p0: FragmentActivity?) =  
        ViewModelProviders.of(this)[${activityClass}ViewModel::class.java]
